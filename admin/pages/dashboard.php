              ...
              <div class="row">
                <div class="col-8 text-start">
                  <div class="icon icon-shape bg-white shadow text-center border-radius-2xl">
                    <i class="fa-solid fa-users text-dark text-lg opacity-10" aria-hidden="true"></i>
                  </div>
                  <h5 class="text-white font-weight-bolder mb-0 mt-3">
                    <?php echo $totalUsuarios; ?>
                  </h5>
                  <span class="text-white text-sm">Usuarios registrados</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="card">
            ...
            <div class="card-body p-3 position-relative">
              <div class="row">
                <div class="col-8 text-start">
                  <div class="icon icon-shape bg-white shadow text-center border-radius-2xl">
                    <i class="fa-solid fa-user-plus text-dark text-lg opacity-10" aria-hidden="true"></i>
                  </div>
                  <h5 class="text-white font-weight-bolder mb-0 mt-3">
                    <?php echo $totalInscripciones; ?>
                  </h5>
                  <span class="text-white text-sm">Inscripciones</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="card">
            ...
            <div class="card-body p-3 position-relative">
              <div class="row">
                <div class="col-8 text-start">
                  <div class="icon icon-shape bg-white shadow text-center border-radius-2xl">
                    <i class="fa-solid fa-user-shield text-dark text-lg opacity-10" aria-hidden="true"></i>
                  </div>
                  <h5 class="text-white font-weight-bolder mb-0 mt-3">
                    <?php echo $totalRoles; ?>
                  </h5>
                  <span class="text-white text-sm">Roles</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="card">
            <div class="card-header pb-0">
              ...
              <p class="text-sm">
                ...
                <span class="font-weight-bold"><?php echo $usuariosEsteMes; ?></span> este mes
              </p>
            </div>
            <div class="card-body">
        ...
        <div class="col-lg-6 col-md-12 mb-4">
          ...
          <div class="card">
            <div class="card-header pb-0">
              ...
              <p class="text-sm">
                <i class="fa fa-arrow-up text-success"></i>
                <span class="font-weight-bold"><?php echo $inscripcionesEsteMes; ?></span> este mes
              </p>
            </div>
            <div class="card-body">
