    ...
    <div class="container-fluid py-4">
      <div class="row">
          ...
          <div class="card mb-4">
            ...
            <div class="card-body px-0 pt-0 pb-2">
              <div class="table-responsive p-0">
                ...
                <table id="tabla-usuarios" class="table align-items-center mb-0 display responsive nowrap" style="width:100%">
                  <thead>
                    <tr>
                      <th>ID</th>
                      <th>Usuario</th>
                  ...
                  <tbody>
                    ...
                    while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
                      ...
                      echo '<td>';
                      echo '<button class="btn btn-sm btn-primary me-1 btn-editar-usuario" 
        data-id="' . $row['id'] . '" 
        ...
        <i class="fa fa-edit"></i>
                      ...
                      echo '<button class="btn btn-sm btn-danger btn-borrar-usuario" data-id="' . $row['id'] . '"><i class="fa fa-trash"></i></button>';
                      echo '</td>';
                    }
                    ?>
                  </tbody>
  ...
  <script>
    ...
    $(document).on('click', '.btn-borrar-usuario', function() {
      if (confirm('¿Seguro que deseas borrar este usuario?')) {
        var id = $(this).data('id');
        $.post('../controllers/usuarios.php', {id: id, action: 'delete'}, function(resp) {
          if (resp === 'ok') {
            location.reload();
          } else {
            alert('Error: ' + resp);
